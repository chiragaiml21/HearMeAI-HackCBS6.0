...
let stories = new Zuck("stories", {
  ...
  stories: [
    ...
    Zuck.buildTimelineItem(
      ...
      // Story photo src
      "../../static/c_assets/images/post/1by1/02.jpg",
    ...
    Zuck.buildTimelineItem(
      "user-2",
      "../../static/c_assets/images/post/1by1/03.jpg",
      "Billy Vasquez",
      "",
      timestamp(),
      [
    ...
    Zuck.buildTimelineItem(
      "user-3",
      "../../static/c_assets/images/post/1by1/04.jpg",
      "Amanda Reed",
      "",
      timestamp(),
      [
    ...
    Zuck.buildTimelineItem(
      "user-4",
      "../../static/c_assets/images/post/1by1/05.jpg",
      "Lori Stevens",
      "",
      timestamp(),
      [
    ...
    Zuck.buildTimelineItem(
      "user-5",
      "../../static/c_assets/images/post/1by1/06.jpg",
      "Samuel Bishop",
      "",
      timestamp(),
      [
    ...
    Zuck.buildTimelineItem(
      "user-6",
      "../../static/c_assets/images/post/1by1/07.jpg",
      "Joan Wallace",
      "",
      timestamp(),
      [
    ...
    // Second way (this way implements only single story with multiple sub-stories)
    {
      ...
      items: [              // array of items
        // Story item 
        {
          ...
          src: "../../static/c_assets/images/post/1by1/05.jpg",      // photo or video src
